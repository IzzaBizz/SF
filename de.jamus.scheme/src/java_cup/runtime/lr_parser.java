...
public abstract class lr_parser {
  ...
  public Symbol scan() throws java.lang.Exception {
      //System.out.println("++1 now in scan()");                   // <------F
  ...
  public Symbol parse() throws java.lang.Exception
	...
	// System.out.println("++ now in parse()");              // <------F
      ...
      // System.out.println("++1 now in parse()");              // <------F

      /* do user initialization */
      user_init();

      // System.out.println("++2 now in parse()");              // <------F
      ...
      // System.out.println("++3 now in parse()");              // <------F
