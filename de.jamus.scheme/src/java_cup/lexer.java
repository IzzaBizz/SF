...
import java.io.BufferedInputStream;                        // <------F
...
public class lexer {
  ...
  public static int warning_count = 0;
    ...
    public static BufferedInputStream bis;            // <---------F
  ...
  /** Initialize the scanner.  This sets up the keywords and char_symbols
    ...
    */
    ...
    public static void init(BufferedInputStream b) throws java.io.IOException
    {
